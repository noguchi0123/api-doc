...
[![Build Status](https://travis-ci.org/noguchi0123/api-doc.svg?branch=master)](https://travis-ci.org/noguchi0123/api-doc)
...
6. If you did everything correct, https://noguchi0123.github.io/api-doc/ will lead to your new docs
...
- Documentation(ReDoc): https://noguchi0123.github.io/api-doc/
- SwaggerUI: https://noguchi0123.github.io/api-doc/swagger-ui/
- Look full spec:
    + JSON https://noguchi0123.github.io/api-doc/swagger.json
    + YAML https://noguchi0123.github.io/api-doc/swagger.yaml
- Preview spec version for branch `[branch]`: https://noguchi0123.github.io/api-doc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://noguchi0123.github.io/api-doc/ with url from the message: `Server started <url>`
